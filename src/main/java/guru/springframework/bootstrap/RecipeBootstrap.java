...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public RecipeBootstrap(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository) {
        log.debug("Called bootstrap constructor...");
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        ...
        log.debug("Called bootstrap save method");
    }
    ...
    private List<Recipe> getRecipes() {
        ...
        chickenTacos.addIngredient(new Ingredient("Clove of Garlic, Chopped", new BigDecimal(1), eachUom));
        chickenTacos.addIngredient(new Ingredient("finely grated orange zestr", new BigDecimal(1), tableSpoonUom));
        ...
        chickenTacos.addIngredient(new Ingredient("boneless chicken thighs", new BigDecimal(4), tableSpoonUom));
        chickenTacos.addIngredient(new Ingredient("small corn tortillas", new BigDecimal(8), eachUom));
        chickenTacos.addIngredient(new Ingredient("packed baby arugula", new BigDecimal(3), cupsUom));
        chickenTacos.addIngredient(new Ingredient("medium ripe avocados, slice", new BigDecimal(2), eachUom));
        ...
        chickenTacos.addIngredient(new Ingredient("red onion, thinly sliced", new BigDecimal(".25"), eachUom));
        chickenTacos.addIngredient(new Ingredient("Roughly chopped cilantro", new BigDecimal(4), eachUom));
        chickenTacos.addIngredient(new Ingredient("cup sour cream thinned with 1/4 cup milk", new BigDecimal(4), cupsUom));
        chickenTacos.addIngredient(new Ingredient("lime, cut into wedges", new BigDecimal(4), eachUom));
        ...
        log.debug("Created bootstrap objects");
